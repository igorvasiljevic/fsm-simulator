...
let mask_fun;
export const mask = (element, callback) => {
    mask_fun = e => {
    ...
    document.addEventListener('pointerdown', mask_fun, { capture:true });
}

export const unmask = () => {
    document.removeEventListener('pointerdown', mask_fun, { capture:true });
    mask_fun = undefined;
}



export const mobile = navigator?.userAgentData ?
